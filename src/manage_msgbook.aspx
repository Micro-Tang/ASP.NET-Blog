<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_msgbook.aspx.cs" Inherits="manage_msgbook" %>
                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="manage_msgbook.aspx">留言板管理</a></li>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <asp:Repeater ID="msgbook_lst" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("username") %></td>
                                                <td><%#Eval("content") %></td>
                                                <td><%#Eval("date") %></td>
                                                <td>
                                                    <asp:LinkButton ID="del" class="btn btn-danger" runat="server" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('是否删除')" OnClick="del_Click">删除</asp:LinkButton>
