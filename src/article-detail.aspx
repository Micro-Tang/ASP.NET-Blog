<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article-detail.aspx.cs" Inherits="article_detail" %>
...
<body>
    <form id="form1" runat="server" class="form-group">
        <div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8" style="min-height: 650px; background-color: #eee; margin: 50px 0 0 0;">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel" style="margin: 5px 0">
                                        <div class="panel-body" style="text-align: center">
                                            <h2>
                                                <asp:Label ID="article_title" runat="server"></asp:Label><br />
                                                <small>
                                                    <asp:Label ID="article_date" runat="server"></asp:Label></small></h2>
                                            
                                            <p id="content_article">
                                                <asp:Label ID="article_content" runat="server"></asp:Label>
                                            </p>
                                            <asp:Label ID="delete" runat="server" Text="" style="float:right" ></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <% if (Session["username"] != null)
                                ...
                                <div class="col-lg-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <textarea style="resize: none" required="required" runat="server" id="comment_content" cols="30" rows="10" class="form-control"></textarea>
                                            <asp:Button ID="comment" runat="server" OnClick="comment_Click" class="btn btn-success" Text="发表评论"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                                <%} %>
                                <div class="col-lg-12">
                                    <div class="panel">
                                        <div class="panel-body">
                                            <asp:Repeater ID="comment_lst" runat="server">
                                                <ItemTemplate>
                                                    <div class="row" style="margin-bottom: 2px; border-bottom: solid 1px #bbb">
                                                        <div class="col-md-3">
                                                            <img src="images/face_<%=new Random().Next(44).ToString() %>.png" />&nbsp;<strong><%#Eval("username") %>：</strong>
                                                        </div>
                                                        <div class="col-md-9">
                                                            <p>
                                                                <strong><%#Eval("content") %></strong>
                                                            </p>
                                                            <h4><small><%#Eval("comment_date") %></small></h4>
                                                        </div>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:Repeater>
