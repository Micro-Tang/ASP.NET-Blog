<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article-write.aspx.cs" Inherits="article_write" %>
                ...
                <div class="row">
                    <div class="col-md-8" style="margin: 50px 0 0 0;">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <asp:TextBox required="required" runat="server" ID="a_title" class="form-control" name="" placeholder="请输入标题" />
                                    <textarea style="resize: none;" required="required" runat="server" id="a_content" class="form-control" cols="30" rows="10" placeholder="请输入内容"></textarea>
                                    <asp:Button ID="submit" OnClick="submit_Click" class="btn btn-success" style="float: right; margin: 5px" runat="server" Text="发表文章" />
                                </div>
                            </div>
                        </div>
                    </div>
