                ...
                <div class="row">
                    <div class="col-md-8" style="margin: 50px 0 0 0;">
                        <div class="container-fluid" style="padding: 10px">
                            <div class="row">
                                <asp:Repeater ID="m_lst" runat="server">
                                    <ItemTemplate>
                                        <div class="col-lg-4">
                                            <div class="panel" style="width: 250px; height: 250px;">
                                                <div class="panel-body">
                                                    <p>
                                                        <img src="./images/face_<%=new Random().Next(44).ToString() %>.png"><span style="font-size: 21px; margin: 0 0 0 10px"><%#Eval("send_username") %></span></p>
                                                    <hr style="border: solid 1px #eee; margin: 0 0 20px 0" />
                                                    <p>
                                                        <%#Eval("content") %>
                                                    </p>
                                                    <h4><small><%#Eval("msg_date") %></small></h4>
                                                    <asp:LinkButton style="float:right" ID="del_msg_btn" runat="server" CommandArgument='<%#Eval("msg_id") %>'  OnClientClick="return confirm('是否删除')" OnClick="Delmsg" >删除</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                    </ItemTemplate>
