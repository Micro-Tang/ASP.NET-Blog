<%@ Page Language="C#" AutoEventWireup="true" CodeFile="photo_dir_detail.aspx.cs" Inherits="photo_dir_detail" %>
                        ...
                        <div class="container-fluid">
                            <div class="row" style="margin: 10px 0">
                                <div class="col-lg-12">
                                    ...
                                    <asp:Button ID="uploadfile_btn" class="btn btn-primary" runat="server" Text="上传图片" OnClick="uploadfile_btn_Click" />
                                </div>
                            </div>
                            <div class="row">
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <div class="col-lg-4" style="min-width: 250px; min-height: 250px;">
                                            <img src='./img/<%#Eval("photo_name") %>' class="img-responsive" />
                                            <asp:LinkButton Style="float: right" ID="delimg" runat="server" CommandArgument='<%#Eval("photos_id") %>' OnClientClick="return confirm('是否删除')" OnClick="delimg_Click">删除</asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
