    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                /*获取博友列表*/
                com.CommandText = string.Format("select * from [user] where (username <> '{0}')", username_session);
                OleDbDataReader friend_lst = com.ExecuteReader();
                f_lst.DataSource = friend_lst;
                f_lst.DataBind();
                friend_lst.Close();
                /*获取个人信息*/
