                ...
                <div class="row">
                    ...
                    <div class="container-fluid">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="manage_user.aspx">用户管理</a></li>
                        ...
                        <div class="panel">
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <asp:Repeater ID="user_lst" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("username") %></td>
                                                <td><%#Eval("email") %></td>
                                                <td><%#Eval("birthday") %></td>
                                                <td>
                                                    <asp:LinkButton ID="del" class="btn btn-danger" runat="server" CommandArgument='<%#Eval("user_id") %>'  OnClientClick="return confirm('是否删除')" OnClick="del_Click" >删除</asp:LinkButton>
